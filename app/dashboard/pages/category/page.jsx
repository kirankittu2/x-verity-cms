...
export default async function Category() {
  const data = await getAllCategories("pages_category");
  return (
      ...
      <main className="pl-10 pr-10 pt-5">
        ...
        <form action={createCategory}>
          <div className="bg-white custom-border p-5 mb-10 flex">
            <input name="main" defaultValue="pages_category" hidden />
            <input name="page" defaultValue="pages" hidden />
            <input
